...
namespace ContactApplication.Controllers
{
    internal class UserController
    {
        ...
        public virtual User GetUserById(int id)
        {
            ...
            if (user == null)
                throw new Exception("User Not Found OR Invalid User Id,  Please Enter Six Digit Another User Id");
            if (!user.IsActive)
                throw new Exception("User is Soft Deleted and Not Allowed to Perform CRUD Operation, " +
